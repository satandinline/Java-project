...
为了生成更真实的公共文化资源，系统对AIGC提示词进行了全面优化：
...
- **强调真实性**：要求生成的内容真实可信，不能明显看出是AI生成的
- **强调详细度**：要求包含具体的文化实践细节，如具体的仪式步骤、具体的习俗活动、具体的文化符号等
- **强调自然性**：要求语言流畅自然，有生活气息，避免模板化和机械化表达
